...
#include "MoSysLiveLinkComponentController.generated.h"
 ...
 */
UCLASS(ClassGroup = (Custom), meta = (DisplayName = "Mo Sys LiveLink Controller", BlueprintSpawnableComponent))
class MOSYSTRACKING_API UMoSysLiveLinkComponentController : public ULiveLinkComponentController
{
    GENERATED_BODY()
    
public:
    UMoSysLiveLinkComponentController();
