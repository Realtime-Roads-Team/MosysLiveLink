...
#include "MoSysTracking/Public/MoSysEncoderComponent.h"
...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UMoSysEncoderComponent);
UClass* Z_Construct_UClass_UMoSysEncoderComponent_NoRegister()
{
	return UMoSysEncoderComponent::StaticClass();
}
...
template<> MOSYSTRACKING_API UClass* StaticClass<UMoSysEncoderComponent>()
{
	return UMoSysEncoderComponent::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_mo_sys_Documents_git_MoSysTracking_unreal_PackagePlugin_output_HostProject_Plugins_MoSysVPFree_Source_MoSysTracking_Public_MoSysEncoderComponent_h_Statics
{
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMoSysEncoderComponent, UMoSysEncoderComponent::StaticClass, TEXT("UMoSysEncoderComponent"), &Z_Registration_Info_UClass_UMoSysEncoderComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMoSysEncoderComponent), 3456982062U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_mo_sys_Documents_git_MoSysTracking_unreal_PackagePlugin_output_HostProject_Plugins_MoSysVPFree_Source_MoSysTracking_Public_MoSysEncoderComponent_h_474364884(TEXT("/Script/MoSysTracking"),
	Z_CompiledInDeferFile_FID_Users_mo_sys_Documents_git_MoSysTracking_unreal_PackagePlugin_output_HostProject_Plugins_MoSysVPFree_Source_MoSysTracking_Public_MoSysEncoderComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_mo_sys_Documents_git_MoSysTracking_unreal_PackagePlugin_output_HostProject_Plugins_MoSysVPFree_Source_MoSysTracking_Public_MoSysEncoderComponent_h_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_mo_sys_Documents_git_MoSysTracking_unreal_PackagePlugin_output_HostProject_Plugins_MoSysVPFree_Source_MoSysTracking_Public_MoSysEncoderComponent_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_mo_sys_Documents_git_MoSysTracking_unreal_PackagePlugin_output_HostProject_Plugins_MoSysVPFree_Source_MoSysTracking_Public_MoSysEncoderComponent_h_Statics::EnumInfo));
// End Registration
