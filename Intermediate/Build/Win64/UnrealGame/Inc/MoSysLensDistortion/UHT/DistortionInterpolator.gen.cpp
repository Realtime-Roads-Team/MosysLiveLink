...
#include "MoSysLensDistortion/Public/DistortionInterpolator.h"
...
UFunction* Z_Construct_UDelegateFunction_MoSysLensDistortion_LensCalSaveFinished__DelegateSignature()
{
	...
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_MoSysLensDistortion_LensCalSaveFinished__DelegateSignature_Statics::FuncParams);
	}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UDistortionInterpolator_SetDistortionCoefficientsForLensData_Statics::NewProp_InCoefficients = { "InCoefficients", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(DistortionInterpolator_eventSetDistortionCoefficientsForLensData_Parms, InCoefficients), Z_Construct_UScriptStruct_FMoSysLensParameters, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_InCoefficients_MetaData), NewProp_InCoefficients_MetaData) }; // 4190614050
...
IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(UDistortionInterpolator);
UClass* Z_Construct_UClass_UDistortionInterpolator_NoRegister()
{
	return UDistortionInterpolator::StaticClass();
}
struct Z_Construct_UClass_UDistortionInterpolator_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UDistortionInterpolator_AddCxTweakNearWide, "AddCxTweakNearWide" }, // 3918117177
		{ &Z_Construct_UFunction_UDistortionInterpolator_AddCyTweakNearWide, "AddCyTweakNearWide" }, // 4257114172
		{ &Z_Construct_UFunction_UDistortionInterpolator_AddEPDTweakNearWide, "AddEPDTweakNearWide" }, // 1834763040
		{ &Z_Construct_UFunction_UDistortionInterpolator_AddFocalDistancePoint, "AddFocalDistancePoint" }, // 2977946280
		{ &Z_Construct_UFunction_UDistortionInterpolator_AddFxTweakNearWide, "AddFxTweakNearWide" }, // 981251039
		{ &Z_Construct_UFunction_UDistortionInterpolator_AddNewSamplePoint, "AddNewSamplePoint" }, // 3043219603
		{ &Z_Construct_UFunction_UDistortionInterpolator_ClearFocalDistance, "ClearFocalDistance" }, // 2631287352
		{ &Z_Construct_UFunction_UDistortionInterpolator_ClearNearWideSplines, "ClearNearWideSplines" }, // 952478229
		{ &Z_Construct_UFunction_UDistortionInterpolator_GenerateAllNearWideSplines, "GenerateAllNearWideSplines" }, // 2283227902
		{ &Z_Construct_UFunction_UDistortionInterpolator_GenerateCxSplineNearWide, "GenerateCxSplineNearWide" }, // 2636539944
		{ &Z_Construct_UFunction_UDistortionInterpolator_GenerateCySplineNearWide, "GenerateCySplineNearWide" }, // 3965344421
		{ &Z_Construct_UFunction_UDistortionInterpolator_GenerateEPDSplineNearWide, "GenerateEPDSplineNearWide" }, // 525716686
		{ &Z_Construct_UFunction_UDistortionInterpolator_GenerateFxSplineNearWide, "GenerateFxSplineNearWide" }, // 2524464546
		{ &Z_Construct_UFunction_UDistortionInterpolator_GetCxSplineValue, "GetCxSplineValue" }, // 858936855
		{ &Z_Construct_UFunction_UDistortionInterpolator_GetCySplineValue, "GetCySplineValue" }, // 1059940489
		{ &Z_Construct_UFunction_UDistortionInterpolator_GetDistortionCoefficientsForLensData, "GetDistortionCoefficientsForLensData" }, // 4175120809
		{ &Z_Construct_UFunction_UDistortionInterpolator_GetEPDSplineValue, "GetEPDSplineValue" }, // 2775033519
		{ &Z_Construct_UFunction_UDistortionInterpolator_GetFocalDistanceTable, "GetFocalDistanceTable" }, // 2830210695
		{ &Z_Construct_UFunction_UDistortionInterpolator_GetFxSplineValue, "GetFxSplineValue" }, // 2648778257
		{ &Z_Construct_UFunction_UDistortionInterpolator_GetSamplePoints, "GetSamplePoints" }, // 2088361347
		{ &Z_Construct_UFunction_UDistortionInterpolator_GetShouldRecomputeDistortionFromFxUndist, "GetShouldRecomputeDistortionFromFxUndist" }, // 3805956242
		{ &Z_Construct_UFunction_UDistortionInterpolator_HasFocalDistance, "HasFocalDistance" }, // 3152793951
		{ &Z_Construct_UFunction_UDistortionInterpolator_IsDesriptionComplete, "IsDesriptionComplete" }, // 2304936985
		{ &Z_Construct_UFunction_UDistortionInterpolator_RefreshLensDistortion, "RefreshLensDistortion" }, // 799798952
		{ &Z_Construct_UFunction_UDistortionInterpolator_RemoveCxTweakNearWide, "RemoveCxTweakNearWide" }, // 2221510349
		{ &Z_Construct_UFunction_UDistortionInterpolator_RemoveCyTweakNearWide, "RemoveCyTweakNearWide" }, // 2926013285
		{ &Z_Construct_UFunction_UDistortionInterpolator_RemoveEPDTweakNearWide, "RemoveEPDTweakNearWide" }, // 1930709028
		{ &Z_Construct_UFunction_UDistortionInterpolator_RemoveFxTweakNearWide, "RemoveFxTweakNearWide" }, // 2065128719
		{ &Z_Construct_UFunction_UDistortionInterpolator_ResetGlobalTweaks, "ResetGlobalTweaks" }, // 627689012
		{ &Z_Construct_UFunction_UDistortionInterpolator_SaveLensCal, "SaveLensCal" }, // 221411732
		{ &Z_Construct_UFunction_UDistortionInterpolator_SaveLensCalAsync, "SaveLensCalAsync" }, // 2182777862
		{ &Z_Construct_UFunction_UDistortionInterpolator_SetDistortionCoefficientsForLensData, "SetDistortionCoefficientsForLensData" }, // 1012646491
		{ &Z_Construct_UFunction_UDistortionInterpolator_SetShouldRecomputeDistortionFromFxUndist, "SetShouldRecomputeDistortionFromFxUndist" }, // 2398407413
		{ &Z_Construct_UFunction_UDistortionInterpolator_Setter_interpolationType, "Setter_interpolationType" }, // 3451915439
		{ &Z_Construct_UFunction_UDistortionInterpolator_UpdateLensSetup, "UpdateLensSetup" }, // 1519437868
	};
...
const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UDistortionInterpolator_Statics::NewProp_InterpolationType = { "InterpolationType", nullptr, (EPropertyFlags)0x0010000001000004, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UDistortionInterpolator, InterpolationType), Z_Construct_UEnum_MoSysLensDistortion_DistortionInterpolationType, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_InterpolationType_MetaData), NewProp_InterpolationType_MetaData) }; // 1220315375
...
template<> MOSYSLENSDISTORTION_API UClass* StaticClass<UDistortionInterpolator>()
{
	return UDistortionInterpolator::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_mo_sys_Documents_git_MoSysTracking_unreal_PackagePlugin_output_HostProject_Plugins_MoSysVPFree_Source_MoSysLensDistortion_Public_DistortionInterpolator_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ DistortionInterpolationType_StaticEnum, TEXT("DistortionInterpolationType"), &Z_Registration_Info_UEnum_DistortionInterpolationType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1220315375U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UDistortionInterpolator, UDistortionInterpolator::StaticClass, TEXT("UDistortionInterpolator"), &Z_Registration_Info_UClass_UDistortionInterpolator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDistortionInterpolator), 2232802704U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_mo_sys_Documents_git_MoSysTracking_unreal_PackagePlugin_output_HostProject_Plugins_MoSysVPFree_Source_MoSysLensDistortion_Public_DistortionInterpolator_h_2617860068(TEXT("/Script/MoSysLensDistortion"),
	Z_CompiledInDeferFile_FID_Users_mo_sys_Documents_git_MoSysTracking_unreal_PackagePlugin_output_HostProject_Plugins_MoSysVPFree_Source_MoSysLensDistortion_Public_DistortionInterpolator_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_mo_sys_Documents_git_MoSysTracking_unreal_PackagePlugin_output_HostProject_Plugins_MoSysVPFree_Source_MoSysLensDistortion_Public_DistortionInterpolator_h_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_mo_sys_Documents_git_MoSysTracking_unreal_PackagePlugin_output_HostProject_Plugins_MoSysVPFree_Source_MoSysLensDistortion_Public_DistortionInterpolator_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_mo_sys_Documents_git_MoSysTracking_unreal_PackagePlugin_output_HostProject_Plugins_MoSysVPFree_Source_MoSysLensDistortion_Public_DistortionInterpolator_h_Statics::EnumInfo));
// End Registration
