...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FLiveLinkMoSysBlueprintData;
class UScriptStruct* FLiveLinkMoSysBlueprintData::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FLiveLinkMoSysBlueprintData.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FLiveLinkMoSysBlueprintData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLiveLinkMoSysBlueprintData, (UObject*)Z_Construct_UPackage__Script_MoSysTracking(), TEXT("LiveLinkMoSysBlueprintData"));
	}
	return Z_Registration_Info_UScriptStruct_FLiveLinkMoSysBlueprintData.OuterSingleton;
}
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FLiveLinkMoSysBlueprintData_Statics::NewProp_StaticData = { "StaticData", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLiveLinkMoSysBlueprintData, StaticData), Z_Construct_UScriptStruct_FLiveLinkMoSysStaticData, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_StaticData_MetaData), NewProp_StaticData_MetaData) }; // 1689976498
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FLiveLinkMoSysBlueprintData_Statics::NewProp_FrameData = { "FrameData", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLiveLinkMoSysBlueprintData, FrameData), Z_Construct_UScriptStruct_FLiveLinkMoSysFrameData, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_FrameData_MetaData), NewProp_FrameData_MetaData) }; // 2222219908
...
{
	if (!Z_Registration_Info_UScriptStruct_FLiveLinkMoSysBlueprintData.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FLiveLinkMoSysBlueprintData.InnerSingleton, Z_Construct_UScriptStruct_FLiveLinkMoSysBlueprintData_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FLiveLinkMoSysBlueprintData.InnerSingleton;
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UMoSysLiveLinkRole;
UClass* UMoSysLiveLinkRole::GetPrivateStaticClass()
{
	using TClass = UMoSysLiveLinkRole;
	if (!Z_Registration_Info_UClass_UMoSysLiveLinkRole.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("MoSysLiveLinkRole"),
			Z_Registration_Info_UClass_UMoSysLiveLinkRole.InnerSingleton,
			StaticRegisterNativesUMoSysLiveLinkRole,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UMoSysLiveLinkRole.InnerSingleton;
}
UClass* Z_Construct_UClass_UMoSysLiveLinkRole_NoRegister()
{
	return UMoSysLiveLinkRole::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_RealtimeRoads_Plugins_VPToolkit_MosysLiveLink_Source_MoSysTracking_Public_MoSysLiveLinkRole_h__Script_MoSysTracking_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FLiveLinkMoSysBlueprintData::StaticStruct, Z_Construct_UScriptStruct_FLiveLinkMoSysBlueprintData_Statics::NewStructOps, TEXT("LiveLinkMoSysBlueprintData"), &Z_Registration_Info_UScriptStruct_FLiveLinkMoSysBlueprintData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLiveLinkMoSysBlueprintData), 2969703203U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMoSysLiveLinkRole, UMoSysLiveLinkRole::StaticClass, TEXT("UMoSysLiveLinkRole"), &Z_Registration_Info_UClass_UMoSysLiveLinkRole, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMoSysLiveLinkRole), 4045444909U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RealtimeRoads_Plugins_VPToolkit_MosysLiveLink_Source_MoSysTracking_Public_MoSysLiveLinkRole_h__Script_MoSysTracking_3930350617(TEXT("/Script/MoSysTracking"),
	Z_CompiledInDeferFile_FID_RealtimeRoads_Plugins_VPToolkit_MosysLiveLink_Source_MoSysTracking_Public_MoSysLiveLinkRole_h__Script_MoSysTracking_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_RealtimeRoads_Plugins_VPToolkit_MosysLiveLink_Source_MoSysTracking_Public_MoSysLiveLinkRole_h__Script_MoSysTracking_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_RealtimeRoads_Plugins_VPToolkit_MosysLiveLink_Source_MoSysTracking_Public_MoSysLiveLinkRole_h__Script_MoSysTracking_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_RealtimeRoads_Plugins_VPToolkit_MosysLiveLink_Source_MoSysTracking_Public_MoSysLiveLinkRole_h__Script_MoSysTracking_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
