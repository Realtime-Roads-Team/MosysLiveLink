...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FLensFileDescription;
class UScriptStruct* FLensFileDescription::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FLensFileDescription.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FLensFileDescription.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLensFileDescription, (UObject*)Z_Construct_UPackage__Script_MoSysLensDistortion(), TEXT("LensFileDescription"));
	}
	return Z_Registration_Info_UScriptStruct_FLensFileDescription.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FLensFileDescription.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FLensFileDescription.InnerSingleton, Z_Construct_UScriptStruct_FLensFileDescription_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FLensFileDescription.InnerSingleton;
}
// ********** End ScriptStruct FLensFileDescription ************************************************

// ********** Begin ScriptStruct FLensSetup ********************************************************
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FLensSetup;
class UScriptStruct* FLensSetup::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FLensSetup.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FLensSetup.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLensSetup, (UObject*)Z_Construct_UPackage__Script_MoSysLensDistortion(), TEXT("LensSetup"));
	}
	return Z_Registration_Info_UScriptStruct_FLensSetup.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FLensSetup.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FLensSetup.InnerSingleton, Z_Construct_UScriptStruct_FLensSetup_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FLensSetup.InnerSingleton;
}
// ********** End ScriptStruct FLensSetup **********************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_RealtimeRoads_Plugins_VPToolkit_MosysLiveLink_Source_MoSysLensDistortion_Public_FLensSetup_h__Script_MoSysLensDistortion_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FLensFileDescription::StaticStruct, Z_Construct_UScriptStruct_FLensFileDescription_Statics::NewStructOps, TEXT("LensFileDescription"), &Z_Registration_Info_UScriptStruct_FLensFileDescription, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLensFileDescription), 793297245U) },
		{ FLensSetup::StaticStruct, Z_Construct_UScriptStruct_FLensSetup_Statics::NewStructOps, TEXT("LensSetup"), &Z_Registration_Info_UScriptStruct_FLensSetup, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLensSetup), 3922929210U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RealtimeRoads_Plugins_VPToolkit_MosysLiveLink_Source_MoSysLensDistortion_Public_FLensSetup_h__Script_MoSysLensDistortion_518290392(TEXT("/Script/MoSysLensDistortion"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_RealtimeRoads_Plugins_VPToolkit_MosysLiveLink_Source_MoSysLensDistortion_Public_FLensSetup_h__Script_MoSysLensDistortion_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_RealtimeRoads_Plugins_VPToolkit_MosysLiveLink_Source_MoSysLensDistortion_Public_FLensSetup_h__Script_MoSysLensDistortion_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
