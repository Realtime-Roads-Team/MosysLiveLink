...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FMoSysLensParameters;
class UScriptStruct* FMoSysLensParameters::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FMoSysLensParameters.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FMoSysLensParameters.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMoSysLensParameters, (UObject*)Z_Construct_UPackage__Script_MoSysLensDistortion(), TEXT("MoSysLensParameters"));
	}
	return Z_Registration_Info_UScriptStruct_FMoSysLensParameters.OuterSingleton;
}
...
{
	if (!Z_Registration_Info_UScriptStruct_FMoSysLensParameters.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FMoSysLensParameters.InnerSingleton, Z_Construct_UScriptStruct_FMoSysLensParameters_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_FMoSysLensParameters.InnerSingleton;
}
...
FClassRegistrationInfo Z_Registration_Info_UClass_UMoSysLensModel;
UClass* UMoSysLensModel::GetPrivateStaticClass()
{
	using TClass = UMoSysLensModel;
	if (!Z_Registration_Info_UClass_UMoSysLensModel.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			StaticPackage(),
			TEXT("MoSysLensModel"),
			Z_Registration_Info_UClass_UMoSysLensModel.InnerSingleton,
			StaticRegisterNativesUMoSysLensModel,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_UMoSysLensModel.InnerSingleton;
}
UClass* Z_Construct_UClass_UMoSysLensModel_NoRegister()
{
	return UMoSysLensModel::GetPrivateStaticClass();
}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_RealtimeRoads_Plugins_VPToolkit_MosysLiveLink_Source_MoSysLensDistortion_Public_MoSysLensModel_h__Script_MoSysLensDistortion_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FMoSysLensParameters::StaticStruct, Z_Construct_UScriptStruct_FMoSysLensParameters_Statics::NewStructOps, TEXT("MoSysLensParameters"), &Z_Registration_Info_UScriptStruct_FMoSysLensParameters, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMoSysLensParameters), 1788929806U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMoSysLensModel, UMoSysLensModel::StaticClass, TEXT("UMoSysLensModel"), &Z_Registration_Info_UClass_UMoSysLensModel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMoSysLensModel), 128569474U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_RealtimeRoads_Plugins_VPToolkit_MosysLiveLink_Source_MoSysLensDistortion_Public_MoSysLensModel_h__Script_MoSysLensDistortion_3402161465(TEXT("/Script/MoSysLensDistortion"),
	Z_CompiledInDeferFile_FID_RealtimeRoads_Plugins_VPToolkit_MosysLiveLink_Source_MoSysLensDistortion_Public_MoSysLensModel_h__Script_MoSysLensDistortion_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_RealtimeRoads_Plugins_VPToolkit_MosysLiveLink_Source_MoSysLensDistortion_Public_MoSysLensModel_h__Script_MoSysLensDistortion_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_RealtimeRoads_Plugins_VPToolkit_MosysLiveLink_Source_MoSysLensDistortion_Public_MoSysLensModel_h__Script_MoSysLensDistortion_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_RealtimeRoads_Plugins_VPToolkit_MosysLiveLink_Source_MoSysLensDistortion_Public_MoSysLensModel_h__Script_MoSysLensDistortion_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
